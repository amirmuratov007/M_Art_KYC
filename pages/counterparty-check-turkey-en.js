...
const points = [
  'Supplier and trading partner verification',
  'Beneficial ownership and nominee risk review',
  'Commercial, sanctions and reputation risk assessment'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Counterparty Check in Turkey | HEIMDALL</title>
        <meta name="description" content="HEIMDALL verifies Turkish counterparties, trading partners and suppliers through corporate intelligence, adverse media analysis and risk exposure mapping." />
        <link rel="canonical" href="https://www.heimdall-group.ru/counterparty-check-turkey-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Counterparty intelligence in Turkey
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL verifies Turkish counterparties, trading partners and suppliers through corporate intelligence, adverse media analysis and risk exposure mapping.
            </p>
