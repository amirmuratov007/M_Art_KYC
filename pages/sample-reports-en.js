...
const blocks = [["Отчёт по контрагенту", "Индекс риска, владение, суды, рекомендация."], ["Отчёт по кандидату", "Биография, репутация, конфликты, уровень риска."], ["AML/KYC отчёт", "Санкции, ПДЛ, негативные источники, бенефициары."], ["Расширенная проверка", "Международные источники и скрытые связи."]]
    ...
    <main className="min-h-screen bg-[#050816] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
        <div className="max-w-5xl">
          ...
          <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">Примеры отчётов для клиентов</h1>
          <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">Демонстрационные форматы отчётов для контрагентов, кандидатов, AML/KYC и расширенной проверки.</p>
        </div>
      </section>
