...
const reports = [
  {
    ...
    text: 'Demo report for a fictional candidate: background, reputation signals, risk indicators and recommendation.',
  ...
  },
  {
    ...
    text: 'Demo report for a fictional company: structure, litigation history, compliance risks and analyst conclusion.',
    file: '/reports/counterparty-intelligence-demo.pdf',
    image: '/report-previews/company-preview.png'
  },
  {
    title: 'Beneficial Owner Review',
    text: 'Demo report for a fictional beneficial owner: links, ownership, reputation signals and recommendation.',
...
export default function SampleReportsPage() {
  return (
    <>
      <Head>
        <title>Sample Reports | HEIMDALL</title>
        <meta name="description" content="HEIMDALL sample reports for candidate screening, company review and beneficial owner review." />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">HEIMDALL Sample Reports</h1>
            <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">
              Three demonstration reports for fictional subjects: a person, a company and a beneficial owner. Download them to review the analytical format.
            </p>
          </div>
        </section>
