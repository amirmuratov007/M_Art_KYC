  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Pricing for counterparty intelligence, candidate screening and due diligence."
        />
      </Head>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
          <div className="max-w-5xl">
            ...
            <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">
              HEIMDALL provides counterparty intelligence, candidate screening and
              confidential due diligence for executive decision-making.
            </p>
          </div>
        </section>
          ...
          <div className="grid gap-8 rounded-[42px] border border-white/10 bg-white/[0.045] p-10 backdrop-blur-2xl md:p-16 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-5 text-4xl font-semibold tracking-[-0.05em] md:text-6xl">
                NDA and secure engagement available on request
              </h2>

              <p className="mt-6 text-lg leading-8 text-white/64">
                International intelligence reviews, sanctions investigations and
                sensitive corporate matters are priced individually.
              </p>
            </div>
