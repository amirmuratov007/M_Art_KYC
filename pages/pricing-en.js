...
function InlineLogo() {
  return (
    <a href="/" className="group inline-flex items-center gap-3">
      <span className="relative flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-[#D6A84F]/35 bg-[#08111F] shadow-[0_0_28px_rgba(214,168,79,0.18)]">
        <span className="absolute inset-x-2 top-2 h-0.5 rounded-full bg-[#F7D784]/60" />
        <span className="absolute inset-x-2 bottom-2 h-0.5 rounded-full bg-[#D6A84F]/50" />
        <span className="text-2xl font-black tracking-[-0.08em] text-[#F7D784]">H</span>
      </span>

      <span>
        <span className="block text-xl font-semibold tracking-[0.34em] text-white transition group-hover:text-[#F7D784]">
          HEIMDALL
        </span>
        <span className="mt-1 block text-[10px] uppercase tracking-[0.22em] text-[#D6A84F]/70">
          Intelligence Group
        </span>
      </span>
    </a>
