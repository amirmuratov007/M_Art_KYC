...
const signals = ["деловая репутация, судебный и санкционный фон", "связанные лица, источники капитала и корпоративные интересы", "риски давления, конфликта интересов и последующего контроля"]
const useCases = ["перед привлечением инвестиций", "перед продажей доли или акций", "при выборе стратегического партнера"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка инвестора | HEIMDALL</title>
        <meta name="description" content="Проверка инвесторов и источников риска: репутация, связи, санкционная экспозиция, судебный фон, структура активов и возможные скрытые интересы." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-investora" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка инвестора перед сделкой
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              Проверка инвесторов и источников риска: репутация, связи, санкционная экспозиция, судебный фон, структура активов и возможные скрытые интересы.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка инвестора" />
      </main>
    </>
  )
}
