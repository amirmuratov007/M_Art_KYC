...
const core = [
  ...
  ['Candidate Screening', 'Conflict of interest, reputation, financial pressure and sensitive roles.', '/background-check', ShieldCheck],
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-5 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-24">
          <div>
            ...
            <div className="mt-9 grid gap-4 sm:flex sm:flex-row">
              ...
              <Link href="/sample-reports" className="inline-flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-6 py-4 font-semibold text-white">View reports</Link>
            </div>
          </div>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 pb-16 sm:px-5 sm:pb-24">
          <div className="grid gap-6 rounded-[36px] border border-[#D6A84F]/20 bg-[#D6A84F]/[0.07] p-6 backdrop-blur-2xl sm:rounded-[42px] sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-6 text-3xl font-semibold tracking-[-0.05em] sm:text-5xl">Business Support бизнеса</h2>
              <p className="mt-5 max-w-3xl text-base leading-8 text-white/64 sm:text-lg">A continuous risk layer for companies. Pricing starts from $2,500 per month.</p>
            </div>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 pb-16 sm:px-5 sm:pb-24">
          <div className="grid gap-6 rounded-[36px] border border-sky-300/20 bg-sky-300/[0.07] p-6 backdrop-blur-2xl sm:rounded-[42px] sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-6 text-3xl font-semibold tracking-[-0.05em] sm:text-5xl">HEIMDALL channel posts</h2>
