...
const signals = ["суды, исполнительные производства и банкротные признаки", "бенефициары, директора и связанные компании", "репутационные сигналы и признаки технической структуры"]
const useCases = ["перед подписанием договора", "перед оплатой аванса", "перед долгосрочным сотрудничеством"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка контрагента перед договором | HEIMDALL</title>
        <meta name="description" content="Проверка контрагента до подписания договора: юридические риски, владельцы, судебная история, финансовые сигналы и репутационный фон." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-kontragenta-pered-dogovorom" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка контрагента перед договором
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              Проверка контрагента до подписания договора: юридические риски, владельцы, судебная история, финансовые сигналы и репутационный фон.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка контрагента перед договором" />
      </main>
    </>
  )
}
