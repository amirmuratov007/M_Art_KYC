  ...
  return (
    <main className="min-h-screen bg-[#050816] text-white">
      ...
      <article className="relative z-10 mx-auto max-w-4xl px-5 py-24">
        ...
        <h1 className="mt-8 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-7xl">Санкционный риск без прямого совпадения</h1>
        <p className="mt-8 text-xl leading-9 text-white/64">Опасность часто проявляется через связи, цепочки владения и бывших директоров.</p>
