...
export default function DemoClientAppEnPage() {
  return (
    <>
      <Head>
        <title>Client App Demo | HEIMDALL</title>
        <meta name="description" content="HEIMDALL client app demo: checks, reports, risk signals and new requests." />
        <link rel="canonical" href="https://www.heimdall-group.ru/demo-client-app-en" />
      </Head>
          ...
          <div className="mb-8 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-white/62">
                Mobile-style demo interface: checks, risk index, reports and fast analyst requests. It does not touch Supabase or real client data.
              </p>
            </div>
            <Link href="/app-download-en" className="inline-flex items-center justify-center gap-3 rounded-2xl bg-sky-500 px-7 py-4 font-semibold text-white">
              Install on phone <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
            ...
            <div className="grid gap-6">
              <div className="rounded-[36px] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-2xl">
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-semibold tracking-[-0.04em]">Checks</h2>
                </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-[36px] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-2xl">
                  <div className="mb-5 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-semibold tracking-[-0.04em]">Signals</h2>
                  </div>
                  <div className="grid gap-3">
                ...
                <div className="rounded-[36px] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-2xl">
                  <div className="mb-5 flex items-center gap-3">
                    ...
                    <h2 className="text-2xl font-semibold tracking-[-0.04em]">Reports</h2>
                  </div>
                  <div className="grid gap-3">
