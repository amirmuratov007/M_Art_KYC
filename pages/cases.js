...
import { ArrowRight, FileSearch, ShieldAlert, Network } from 'lucide-react'
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Обезличенные кейсы HEIMDALL: проверка контрагентов, кандидатов, скрытых бенефициаров и due diligence перед сделкой." />
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 pb-32 sm:px-5">
          <div className="rounded-[42px] border border-[#D6A84F]/20 bg-[#D6A84F]/[0.07] p-8 backdrop-blur-2xl md:p-12">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-white/64">
              HEIMDALL помогает увидеть проблему до сделки, найма, партнерства или передачи доступа.
            </p>
          </div>
        </section>
