...
const palette = [
  ['#050816', 'Deep Black', 'primary background'],
  ['#08111F', 'Midnight Navy', 'sections and cards'],
  ['#1E3A5F', 'Steel Blue', 'borders and structure'],
  ['#93C5FD', 'Ice Blue', 'accents and links'],
  ['#38BDF8', 'Executive Cyan', 'CTA and interaction']
]

const sections = [
  ['Positioning', 'HEIMDALL is a premium corporate intelligence, due diligence and candidate screening advisory firm.'],
  ['Brand Character', 'Calm authority, confidentiality, precision, strategic thinking and executive-level presentation.'],
  ['Tone of Voice', 'Concise, confident and analytical. No noise, no hype and no cheap marketing promises.'],
  ['Visual Style', 'Dark finance, intelligence infrastructure, premium legal advisory and Scandinavian minimalism.']
]
...
export default function BrandbookRu() {
  return (
    <>
      <Head>
        <title>HEIMDALL Brandbook</title>
        <meta name="description" content="HEIMDALL corporate brandbook in English." />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <header className="relative z-10 border-b border-white/10 bg-[#050816]/70 backdrop-blur-2xl">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5">
            ...
            <div className="flex gap-3">
              ...
              <a href="/heimdall-brandbook-en.pdf" className="rounded-full bg-sky-500 px-4 py-2 text-sm font-semibold">Download PDF</a>
            </div>
          </div>
        </header>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              HEIMDALL
              <br />
              Intelligence. Risk. Trust.
            </h1>
            <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">
              A visual and strategic identity system for a premium corporate intelligence and risk advisory firm.
            </p>
          </div>
        </section>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 pb-24">
          <div className="rounded-[42px] border border-white/10 bg-white/[0.045] p-8 backdrop-blur-2xl md:p-12">
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
              <div>
                <div className="text-sm uppercase tracking-[0.25em] text-sky-300/80">Logo</div>
                <h2 className="mt-4 text-4xl font-semibold tracking-[-0.04em] md:text-6xl">A symbol of observation and structure</h2>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 pb-24">
          <div className="mb-10">
            <div className="text-sm uppercase tracking-[0.25em] text-sky-300/80">Color System</div>
            <h2 className="mt-4 text-4xl font-semibold tracking-[-0.04em] md:text-6xl">Dark Premium Palette</h2>
          </div>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 pb-32">
          <div className="rounded-[42px] border border-sky-300/20 bg-gradient-to-br from-sky-500/12 via-white/[0.04] to-transparent p-10 backdrop-blur-2xl md:p-16">
            <div className="text-sm uppercase tracking-[0.25em] text-sky-300/80">Final Brand Impression</div>
            <h2 className="mt-6 max-w-5xl text-5xl font-semibold leading-[0.95] tracking-[-0.05em] md:text-7xl">
              “These people probably know more than they publicly say.”
            </h2>
          </div>
        </section>
      </main>
