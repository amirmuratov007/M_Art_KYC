...
const packages = [
  ['Essential Business Support', 'from $2,500 / month', 'up to 8 reviews per month', 'counterparty and candidate screening', 'monthly risk overview'],
  ['Enhanced Business Support', 'from $4,500 / month', 'up to 18 reviews per month', 'enhanced reports', 'client application access'],
  ['Strategic Intelligence Support', 'from $7,500 / month', 'custom review volume', 'corporate intelligence', 'confidential workflow and NDA']
]
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <header className="relative z-10 border-b border-white/10 bg-[#050816]/75 backdrop-blur-2xl">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#support-request" className="rounded-full bg-sky-500 px-5 py-2.5 text-sm font-semibold">Request support</a>
            </div>
          </div>
        </header>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-5 py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">Continuous protection from hidden business risks</h1>
            <p className="mt-9 max-w-3xl text-xl leading-9 text-white/64">HEIMDALL supports companies on a monthly basis: reviewing counterparties, candidates, suppliers, beneficial owners, transactions and reputation risks before they become problems.</p>
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a href="#support-request" className="inline-flex items-center justify-center gap-3 rounded-2xl bg-sky-500 px-7 py-4 font-semibold text-white shadow-[0_0_45px_rgba(56,189,248,0.28)]">Request support <ArrowRight className="h-4 w-4" /></a>
              <Link href="/sample-reports-en" className="inline-flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-7 py-4 font-semibold text-white">View reports</Link>
            </div>
          </div>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 pb-24">
          <div className="mb-10 max-w-4xl"><div className="text-sm uppercase tracking-[0.25em] text-sky-300/80">Pricing</div><h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em] md:text-6xl">Monthly support pricing</h2></div>
        ...
        <section id="support-request" className="relative z-10 mx-auto max-w-4xl px-5 pb-32"><SupportRequestForm language="en" /></section>
      </main>
    </>
  )
}
