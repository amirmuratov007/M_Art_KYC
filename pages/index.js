  ...
  return (
    <>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 pb-16 sm:px-5 sm:pb-24">
          <div className="grid gap-5 rounded-[32px] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-2xl sm:rounded-[42px] sm:p-8 md:p-12 lg:grid-cols-3">
            <div>
              <div className="text-sm uppercase tracking-[0.25em] text-[#F7D784]/80">Почему это важно</div>
              <h2 className="mt-4 text-3xl font-semibold tracking-[-0.05em] sm:text-4xl">Ошибка в проверке стоит дороже самой проверки</h2>
            </div>
            {[
              ...
              <div key={title} className="rounded-[26px] border border-white/10 bg-black/20 p-5 sm:rounded-[30px] sm:p-6">
