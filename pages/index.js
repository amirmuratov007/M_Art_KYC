...
import { ArrowRight, ShieldCheck, FileSearch, LockKeyhole, Network, Gauge, Bell, Smartphone } from 'lucide-react'
          ...
          <div className="grid gap-6 rounded-[36px] border border-[#D6A84F]/20 bg-[#D6A84F]/[0.07] p-6 backdrop-blur-2xl sm:rounded-[42px] sm:p-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
            <div>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                ...
                <Link href="/business-support-en" className="inline-flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-6 py-4 font-semibold text-white">
                  English version
                </Link>
              </div>
            </div>
