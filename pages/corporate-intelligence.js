...
const faq = [["Что такое корпоративная разведка?", "Это анализ рисков, связей и скрытых сигналов."], ["Для чего нужна?", "Для сделок, инвестиций и проверки партнёров."]]
      ...
      <main className="min-h-screen bg-[#050816] px-5 py-20 text-white">
        <div className="mx-auto max-w-5xl">
          ...
          <section className="mt-16 grid gap-5 md:grid-cols-2">
            ['Business intelligence','Due diligence','Risk analytics','Counterparty intelligence'].map((item) => (
