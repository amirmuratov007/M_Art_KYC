...
const points = ["проверка поставщика или торгового партнера", "бенефициары, номиналы и скрытый контроль", "коммерческие, санкционные и репутационные риски"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка контрагента в Турции | HEIMDALL</title>
        <meta name="description" content="HEIMDALL проверяет турецкие компании, торговых партнеров и поставщиков через корпоративную разведку, adverse media и анализ связей." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-kontragenta-turkey" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка контрагента в Турции
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL проверяет турецкие компании, торговых партнеров и поставщиков через корпоративную разведку, adverse media и анализ связей.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка контрагента в Турции" />
      </main>
    </>
  )
}
