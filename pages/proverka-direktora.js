...
const signals = ["управленческая история и связанные юридические лица", "судебные, долговые и репутационные сигналы", "признаки номинальности и конфликта интересов"]
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              Проверка директора перед сделкой, назначением или партнерством: деловая биография, связанные компании, судебные риски, репутация и конфликт интересов.
            </p>
