...
const signals = ["участие в других компаниях и структурах", "судебные споры, банкротства и долговые сигналы", "связанные лица, номинальные признаки и скрытый контроль"]
const useCases = ["при проверке контрагента перед сделкой", "при анализе фактических владельцев", "при оценке рисков партнерства"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка учредителя | HEIMDALL</title>
        <meta name="description" content="HEIMDALL анализирует учредителей компаний: участие в других бизнесах, судебные риски, связи, репутацию и признаки номинального участия." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-uchreditelya" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка учредителя и связанных лиц
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL анализирует учредителей компаний: участие в других бизнесах, судебные риски, связи, репутацию и признаки номинального участия.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка учредителя" />
      </main>
    </>
  )
}
