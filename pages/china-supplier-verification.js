...
const points = ["идентификация компании и деловой профиль", "экспортные, санкционные и репутационные индикаторы", "цепочка поставок и риски посредников"]
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="HEIMDALL проверяет китайских поставщиков, производителей и посредников перед закупками, импортом, дистрибуцией или долгосрочными контрактами." />
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL проверяет китайских поставщиков, производителей и посредников перед закупками, импортом, дистрибуцией или долгосрочными контрактами.
            </p>
