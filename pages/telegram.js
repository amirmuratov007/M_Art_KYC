  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.heimdall-group.ru/telegram" />
        ...
        <meta property="og:url" content="https://www.heimdall-group.ru/telegram" />
      </Head>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Telegram-канал о рисках, которые лучше увидеть заранее
            </h1>
