...
const blocks = [["Counterparty report", "Risk score, ownership, litigation, recommendation."], ["Candidate report", "Background, reputation, conflicts, risk level."], ["AML/KYC report", "Sanctions, PEP, adverse media, beneficial owners."], ["Enhanced review", "International sources and hidden affiliations."]]
    ...
    <main className="min-h-screen bg-[#050816] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
        <div className="max-w-5xl">
          ...
          <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">Sample reports for clients</h1>
          <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">Demo report formats for counterparties, candidates, AML/KYC and enhanced intelligence reviews.</p>
        </div>
      </section>
