...
const checks = [
  'структура владения, бенефициары и связанные компании',
  'судебные споры, исполнительные производства и банкротные сигналы',
  'репутационные риски, санкционная экспозиция и adverse media',
  'финансовые, закупочные и управленческие red flags',
  'риски сделки, инвестиций, партнерства или покупки доли'
]

const scenarios = [
  'перед покупкой бизнеса или доли',
  'перед инвестициями или стратегическим партнерством',
  'перед крупной сделкой с российской компанией',
  'перед допуском контрагента к чувствительным процессам'
]
...
export default function DueDiligenceRussiaPage() {
  ...
  return (
    <>
      <Head>
        <title>Due Diligence в России | HEIMDALL</title>
        <meta name="description" content="Due Diligence бизнеса в России: проверка компаний, бенефициаров, судебных рисков, связей, репутации и санкционной экспозиции." />
        <link rel="canonical" href="https://www.heimdall-group.ru/due-diligence-russia" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              Комплексная проверка бизнеса, контрагентов, владельцев и корпоративных рисков перед сделкой, инвестициями, партнерством или покупкой доли.
            </p>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 pb-24 sm:px-5">
          <div className="mb-10 max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em] md:text-6xl">
              Проверка до сделки снижает риск финансовых и репутационных потерь
            </h2>
          </div>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Due Diligence в России" />
      </main>
    </>
  )
}
