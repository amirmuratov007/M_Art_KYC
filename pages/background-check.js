...
export default function Page() {
  return (
    <>
      <Head>
        <title>Background Check | HEIMDALL</title>
        <meta name="description" content="Комплексная проверка биографии и репутации." />
      </Head>
      ...
      <main className="min-h-screen bg-[#050816] text-white px-5 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-10 text-xl leading-9 text-white/65">
            Комплексная проверка биографии и репутации.
          </p>
