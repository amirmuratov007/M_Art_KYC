...
const signals = ["аффилированность поставщиков и сотрудников", "повторяющиеся победители, странные цены и слабая конкуренция", "технические компании, номиналы и связанные лица"]
const useCases = ["при внутреннем аудите закупок", "перед крупным тендером или выбором поставщика", "при подозрении на конфликт интересов"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка закупок | HEIMDALL</title>
        <meta name="description" content="HEIMDALL помогает выявлять закупочные риски: аффилированность поставщиков, конфликт интересов, технические компании и завышение стоимости." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-zakupok" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка закупок и поставщиков
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL помогает выявлять закупочные риски: аффилированность поставщиков, конфликт интересов, технические компании и завышение стоимости.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка закупок" />
      </main>
    </>
  )
}
