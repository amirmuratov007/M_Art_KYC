...
const points = [
  'Direct and indirect PEP exposure review',
  'Family, associate and connected-party indicators',
  'Risk summary for compliance and onboarding'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>PEP Screening | HEIMDALL</title>
        <meta name="description" content="HEIMDALL conducts politically exposed person screening and indirect exposure analysis for onboarding, compliance, transactions and enhanced due diligence." />
        <link rel="canonical" href="https://www.heimdall-group.ru/pep-screening-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              PEP screening and exposure analysis
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL conducts politically exposed person screening and indirect exposure analysis for onboarding, compliance, transactions and enhanced due diligence.
            </p>
