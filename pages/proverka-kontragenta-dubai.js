...
export default function Page() {
  return (
    <>
      <Head>
        <title>Проверка контрагенента в Дубае | HEIMDALL</title>
        <meta name="description" content="Комплексная проверка компаний и бенефициаров в ОАЭ." />
      </Head>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-6">
          <div className="max-w-5xl">
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64">
              Комплексная проверка компаний и бенефициаров в ОАЭ.
            </p>
          </div>
        </section>
