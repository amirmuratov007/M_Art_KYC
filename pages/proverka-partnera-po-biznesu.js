...
const signals = ["фактические бенефициары и деловые связи", "конфликты интересов, судебная история и репутационные сигналы", "признаки скрытого контроля, номиналов и токсичных связей"]
const useCases = ["перед созданием совместного бизнеса", "перед инвестированием или передачей доли", "перед допуском партнера к управлению или финансам"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка партнера по бизнесу | HEIMDALL</title>
        <meta name="description" content="HEIMDALL помогает оценить будущего партнера по бизнесу: связи, бенефициаров, конфликты, судебные риски, репутацию и признаки скрытого контроля." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-partnera-po-biznesu" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка партнера по бизнесу
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL помогает оценить будущего партнера по бизнесу: связи, бенефициаров, конфликты, судебные риски, репутацию и признаки скрытого контроля.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка партнера по бизнесу" />
      </main>
    </>
  )
}
