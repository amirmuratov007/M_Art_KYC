...
const signals = ["структура владения, бенефициары и связанные компании", "юридические, судебные и финансовые риски", "репутационный фон, санкционные сигналы и управленческие риски"]
const useCases = ["перед покупкой бизнеса или доли", "перед инвестициями или партнерством", "при оценке скрытых рисков сделки"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Due Diligence бизнеса в России | HEIMDALL</title>
        <meta name="description" content="Комплексная проверка бизнеса в России перед сделкой, инвестициями, партнерством или покупкой доли: структура, владельцы, риски и репутация." />
        <link rel="canonical" href="https://www.heimdall-group.ru/due-diligence-biznesa-v-rossii" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Due Diligence бизнеса в России
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              Комплексная проверка бизнеса в России перед сделкой, инвестициями, партнерством или покупкой доли: структура, владельцы, риски и репутация.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Due Diligence бизнеса в России" />
      </main>
    </>
  )
}
