...
const points = [
  'Finance leadership background review',
  'Conflict-of-interest and exposure indicators',
  'Risk assessment before sensitive appointment'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>CFO Screening | HEIMDALL</title>
        <meta name="description" content="HEIMDALL screens CFO candidates and finance executives for reputational risks, conflicts of interest, financial exposure indicators and sensitive access risks." />
        <link rel="canonical" href="https://www.heimdall-group.ru/cfo-screening-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              CFO and finance executive screening
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL screens CFO candidates and finance executives for reputational risks, conflicts of interest, financial exposure indicators and sensitive access risks.
            </p>
