...
const points = [
  'Monthly intelligence monitoring',
  'Counterparty, supplier and executive checks',
  'Risk alerts and analyst summaries'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Business Intelligence Support | HEIMDALL</title>
        <meta name="description" content="HEIMDALL provides ongoing intelligence support for companies that require continuous verification of counterparties, suppliers, executives and risk signals." />
        <link rel="canonical" href="https://www.heimdall-group.ru/business-intelligence-support-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Ongoing business intelligence support
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL provides ongoing intelligence support for companies that require continuous verification of counterparties, suppliers, executives and risk signals.
            </p>
