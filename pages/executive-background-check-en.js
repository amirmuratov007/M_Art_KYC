...
const points = [
  'Career, reputation and conflict-of-interest review',
  'Adverse media and litigation signal analysis',
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="HEIMDALL conducts executive background checks for sensitive roles, leadership appointments, investment decisions and high-trust corporate access." />
        <link rel="canonical" href="https://www.heimdall-group.ru/executive-background-check-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL conducts executive background checks for sensitive roles, leadership appointments, investment decisions and high-trust corporate access.
            </p>
