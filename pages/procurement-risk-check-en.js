...
const points = [
  'Vendor and procurement network review',
  'Related-party and hidden control indicators',
  'Red flags for procurement fraud and conflicts'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Procurement Risk Check | HEIMDALL</title>
        <meta name="description" content="HEIMDALL helps identify supplier manipulation, related-party risks, procurement corruption indicators and hidden commercial exposure before contracts are approved." />
        <link rel="canonical" href="https://www.heimdall-group.ru/procurement-risk-check-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL helps identify supplier manipulation, related-party risks, procurement corruption indicators and hidden commercial exposure before contracts are approved.
            </p>
