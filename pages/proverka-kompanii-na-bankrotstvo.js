...
const signals = ["банкротные дела, судебные и исполнительные сигналы", "долговая нагрузка и связанные проблемные структуры", "риски неплатежа, срыва поставки или вывода активов"]
const useCases = ["перед отсрочкой платежа", "перед поставкой товара или услуг", "при проверке надежности контрагента"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка компании на банкротство | HEIMDALL</title>
        <meta name="description" content="HEIMDALL анализирует признаки банкротного риска компании: судебную нагрузку, долги, исполнительные производства, связанные лица и финансовые сигналы." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-kompanii-na-bankrotstvo" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка компании на признаки банкротства
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL анализирует признаки банкротного риска компании: судебную нагрузку, долги, исполнительные производства, связанные лица и финансовые сигналы.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка компании на банкротство" />
      </main>
    </>
  )
}
