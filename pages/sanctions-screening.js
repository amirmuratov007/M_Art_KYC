...
export default function Page() {
  return (
    <>
      <Head>
        <title>Санкционная проверка | HEIMDALL</title>
        <meta name="description" content="Проверка прямых и косвенных санкционных рисков." />
      </Head>
      ...
      <main className="min-h-screen bg-[#050816] text-white px-5 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-10 text-xl leading-9 text-white/65">
            Проверка прямых и косвенных санкционных рисков.
          </p>
