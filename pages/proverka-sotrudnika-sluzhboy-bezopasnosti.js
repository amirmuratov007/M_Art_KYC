...
const signals = ["репутационные и поведенческие сигналы", "скрытые связи, конфликт интересов и финансовая нагрузка", "риски доступа к данным, деньгам и инфраструктуре"]
const useCases = ["при найме на чувствительную позицию", "при внутренней проверке", "перед допуском к коммерческой тайне"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка сотрудника службой безопасности | HEIMDALL</title>
        <meta name="description" content="HEIMDALL помогает службам безопасности проверять кандидатов и сотрудников на чувствительных позициях: связи, конфликты, репутация и риски доступа." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-sotrudnika-sluzhboy-bezopasnosti" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL помогает службам безопасности проверять кандидатов и сотрудников на чувствительных позициях: связи, конфликты, репутация и риски доступа.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка сотрудника службой безопасности" />
      </main>
    </>
  )
}
