...
export default async function handler(req, res) {
  ...
  const packageType = clean(body.packageType) || 'Комплексное сопровождение'
  ...
  const payload = { name, company, contact, packageType, message, language }

  const text = [
    '🛡️ Новая заявка HEIMDALL',
    '',
    'Тип: сопровождение бизнеса',
