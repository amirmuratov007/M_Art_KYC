...
const signals = ["конфликт интересов и скрытые деловые связи", "репутационные, судебные и финансовые сигналы", "риски доступа к деньгам, данным и управленческим решениям"]
const useCases = ["перед назначением CFO, CEO или руководителя закупок", "перед передачей финансового контура", "при найме на чувствительную позицию"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка кандидата на руководящую должность | HEIMDALL</title>
        <meta name="description" content="Проверка топ-менеджеров и руководителей перед назначением: конфликт интересов, репутация, финансовая нагрузка, связи и чувствительные риски." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-kandidata-na-rukovodyashchuyu-dolzhnost" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Проверка кандидата на руководящую должность
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              Проверка топ-менеджеров и руководителей перед назначением: конфликт интересов, репутация, финансовая нагрузка, связи и чувствительные риски.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка кандидата на руководящую должность" />
      </main>
    </>
  )
}
