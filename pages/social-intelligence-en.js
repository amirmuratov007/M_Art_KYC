...
const blocks = [["Telegram-заметки", "Ежедневные посты для доверия и экспертности."], ["LinkedIn-публикации", "Executive risk advisory формат."], ["Share cards", "Брендированные превью для кейсов и отчётов."], ["Контент-цикл", "Telegram → журнал → SEO → заявка."]]
    ...
    <main className="min-h-screen bg-[#050816] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
        <div className="max-w-5xl">
          ...
          <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">Telegram и LinkedIn как витрина экспертизы HEIMDALL</h1>
          <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">Контент-система превращает ежедневные заметки в доверие, SEO и входящие заявки.</p>
        </div>
      </section>
