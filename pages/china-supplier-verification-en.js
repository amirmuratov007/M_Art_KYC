...
const points = [
  'Supplier identity and corporate profile review',
  'Export, sanctions and adverse media indicators',
  'Supply chain risk and intermediary exposure mapping'
]
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="HEIMDALL verifies Chinese suppliers, manufacturers and intermediaries before procurement, distribution, import operations or long-term supply chain engagement." />
        <link rel="canonical" href="https://www.heimdall-group.ru/china-supplier-verification-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL verifies Chinese suppliers, manufacturers and intermediaries before procurement, distribution, import operations or long-term supply chain engagement.
            </p>
