...
const reports = [
  {
    ...
    text: 'Большой демонстрационный отчёт по вымышленному кандидату: конфликт интересов, финансовая нагрузка, несоответствия в биографии, репутационные сигналы и итоговая рекомендация.',
    file: '/reports/candidate-screening-premium-demo.pdf',
    image: '/report-previews/candidate-premium-preview.png'
  },
  {
    title: 'Отчёт по компании',
    badge: 'Counterparty Intelligence',
    text: 'Развёрнутый отчёт по вымышленному поставщику: цепочка поставок, судебная нагрузка, косвенная санкционная экспозиция, связанные компании и карта владения.',
    file: '/reports/counterparty-intelligence-premium-demo.pdf',
    image: '/report-previews/counterparty-premium-preview.png'
  },
  {
    title: 'Отчёт по бенефициарам',
    badge: 'Beneficial Ownership Review',
    text: 'Отчёт по вымышленной группе бенефициаров: скрытый контроль, номинальные лица, конфликт интересов, корпоративные споры и сеть связанных лиц.',
    file: '/reports/beneficial-owner-premium-demo.pdf',
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Большие демонстрационные отчёты HEIMDALL по кандидату, компании и бенефициарам." />
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
          <div className="max-w-5xl">
            ...
            <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">
              Три больших демонстрационных отчёта по вымышленным объектам: человек, компания и бенефициары. Каждый отчёт показывает, как HEIMDALL выявляет риски, проблемы, связи и формирует управленческий вывод.
            </p>
          </div>
        </section>
