...
const points = [
  'UAE sanctions and PEP exposure review',
  'Beneficial ownership and connected-party analysis',
  'Enhanced due diligence for cross-border operations'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Sanctions Screening Dubai | HEIMDALL</title>
        <meta name="description" content="HEIMDALL screens UAE counterparties, beneficial owners and transaction participants for sanctions exposure, PEP risks and indirect high-risk connections." />
        <link rel="canonical" href="https://www.heimdall-group.ru/sanctions-screening-dubai-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Sanctions screening in Dubai
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL screens UAE counterparties, beneficial owners and transaction participants for sanctions exposure, PEP risks and indirect high-risk connections.
            </p>
