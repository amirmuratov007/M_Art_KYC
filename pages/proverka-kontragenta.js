...
const faq = [["Как проверить контрагента?", "Проверить суды, санкции, бенефициаров и репутационные сигналы."], ["Что входит в проверку?", "Структура владения, суды, долги, санкции и негативные сигналы."]]
      ...
      <main className="min-h-screen bg-[#050816] px-5 py-20 text-white">
        <div className="mx-auto max-w-5xl">
          ...
          <section className="mt-16 grid gap-5 md:grid-cols-2">
            ['Скрытые владельцы','Судебные риски','Санкционные проверки','Проверка репутации'].map((item) => (
