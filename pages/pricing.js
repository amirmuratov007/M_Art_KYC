...
const oneTimeServices = [
  {
    ...
    price: '19 000 ₽',
    term: '1 рабочий день',
    text: 'Первый безопасный шаг перед авансом, договором, отсрочкой платежа или новой закупкой.',
    includes: ['регистрационные данные, руководители и владельцы', 'суды, взыскания, банкротные и долговые сигналы', 'санкционные и репутационные риски', 'краткий вывод по следующему шагу'],
    icon: SearchCheck,
