...
const plans = [
  ...
  },
  {
    ...
    features: [
      'Судебная история',
      'Санкционные риски',
      'Бенефициары и связанные лица',
      'Репутационный анализ',
      'Краткий индекс риска'
    ]
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Прайс-лист HEIMDALL: стоимость проверки кандидатов, контрагентов и комплексной проверки бизнеса."
        />
      </Head>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 py-24">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-10 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Прайс-лист на аналитические проверки
            </h1>

            <p className="mt-10 max-w-3xl text-xl leading-9 text-white/64">
              Фиксированные базовые форматы для проверки кандидатов, контрагентов и бизнеса.
              Сложные международные и конфиденциальные кейсы рассчитываются индивидуально.
            </p>
          </div>
        </section>
          ...
          <div className="grid gap-8 rounded-[42px] border border-white/10 bg-white/[0.045] p-10 backdrop-blur-2xl md:p-16 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-5 text-4xl font-semibold tracking-[-0.05em] md:text-6xl">
                NDA и закрытый формат работы доступны по запросу
              </h2>

              <p className="mt-6 text-lg leading-8 text-white/64">
                Международные проверки, глубокая корпоративная разведка, санкционные расследования
                и чувствительные проекты рассчитываются отдельно.
              </p>
            </div>
            ...
            <div className="rounded-[34px] border border-sky-300/20 bg-sky-300/10 p-8">
              ...
              <div className="mt-5 text-white/65 leading-8">
                ...
                корпоративная разведка и конфиденциальные проекты — от 150 000 ₽.
              </div>
            </div>
          </div>
        </section>
