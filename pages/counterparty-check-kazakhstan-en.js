...
const points = [
  'Corporate records and ownership indicators',
  'Litigation, enforcement and reputational signals',
  'Risk assessment for cross-border cooperation'
]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Counterparty Check in Kazakhstan | HEIMDALL</title>
        <meta name="description" content="HEIMDALL helps companies assess Kazakhstan-based counterparties, suppliers, beneficial owners and commercial risks before transactions, onboarding or long-term cooperation." />
        <link rel="canonical" href="https://www.heimdall-group.ru/counterparty-check-kazakhstan-en" />
      </Head>
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-9 text-5xl font-semibold leading-[0.95] tracking-[-0.06em] md:text-8xl">
              Counterparty intelligence in Kazakhstan
            </h1>

            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL helps companies assess Kazakhstan-based counterparties, suppliers, beneficial owners and commercial risks before transactions, onboarding or long-term cooperation.
            </p>
