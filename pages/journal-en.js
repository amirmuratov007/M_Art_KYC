...
const categories = ['All', ...Array.from(new Set(telegramPosts.map((post) => post.category)))]
...
export default function JournalEnPage() {
  ...
  return (
    <>
      <Head>
        <title>Telegram Journal | HEIMDALL</title>
        <meta name="description" content="HEIMDALL journal on counterparty intelligence, executive screening, beneficial ownership, sanctions exposure and due diligence." />
        <link rel="canonical" href="https://www.heimdall-group.ru/journal-en" />
      </Head>
          ...
          <div className="grid gap-8 rounded-[42px] border border-sky-300/20 bg-gradient-to-br from-sky-500/12 via-white/[0.04] to-transparent p-10 backdrop-blur-2xl md:p-16 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-white/64">
                Short intelligence notes about counterparties, executives, beneficial ownership and corporate risk.
              </p>
            </div>
