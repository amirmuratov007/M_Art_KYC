...
const points = ["корпоративная структура и владельцы", "судебные, исполнительные и репутационные сигналы", "риски трансграничного сотрудничества"]
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>Проверка контрагента в Казахстане | HEIMDALL</title>
        <meta name="description" content="HEIMDALL помогает оценить казахстанских контрагентов, поставщиков, бенефициаров и коммерческие риски до сделки или партнерства." />
        <link rel="canonical" href="https://www.heimdall-group.ru/proverka-kontragenta-kazakhstan" />
      </Head>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050816] text-white">
        ...
        <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-5 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
              HEIMDALL помогает оценить казахстанских контрагентов, поставщиков, бенефициаров и коммерческие риски до сделки или партнерства.
            </p>
        ...
        <HeimdallFooter />
        <ContactModal open={open} onClose={() => setOpen(false)} language="ru" defaultTopic="Проверка контрагента в Казахстане" />
      </main>
    </>
  )
}
