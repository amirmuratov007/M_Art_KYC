...
const copy = {
  ru: {
    ...
    subtitle: 'Background Screening для рекрутинговых агентств',
    ...
    comicTitle: 'Типичный сценарий без предварительной проверки',
    comic: [
      ...
      ['04', 'СБ останавливает процесс', 'После внутренней проверки появляются критичные red flags.'],
    ...
    deliver: [
      'краткий confidential report',
      'понятный risk score',
      'red flags до передачи клиенту',
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-5 pb-24">
          <div className="mb-10 max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-0.04em] md:text-6xl">
              {language === 'ru' ? 'Комикс без картинок — значит ничего не исчезнет' : 'A visual story without external images'}
            </h2>
          </div>
          ...
          <div className="rounded-[42px] border border-white/10 bg-white/[0.045] p-8 backdrop-blur-2xl md:p-12">
            <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-semibold tracking-[-0.04em] md:text-6xl">
                  {language === 'ru' ? 'Screening до передачи финалиста клиенту' : 'Screening before finalist submission'}
                </h2>
              </div>
