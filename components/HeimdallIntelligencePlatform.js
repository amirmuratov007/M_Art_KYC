...
const activityFeed = [
  'Обнаружена новая связанная компания у контрагента',
  'Изменилась структура владения поставщика',
  'Найден репутационный риск в открытых источниках',
  'Выявлен закупочный red flag',
]

const sanctions = [
  ['OFAC', 'Низкий риск'],
  ['ЕС', 'Совпадений нет'],
  ['Великобритания', 'Мониторинг'],
  ['PEP', 'Требует анализа'],
]

export default function HeimdallIntelligencePlatform() {
  return (
    <section className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-5">
      <div className="max-w-5xl">
        ...
        <h2 className="mt-8 text-5xl font-semibold tracking-[-0.06em] md:text-8xl">
          Платформа корпоративной разведки
        </h2>

        <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
          Премиальный интерфейс HEIMDALL для проверки контрагентов,
          анализа владельцев, санкционного мониторинга и проверки руководителей.
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="mt-4 text-4xl font-semibold tracking-[-0.05em]">
                  Экспозиция корпоративных рисков
                </div>
              </div>
