...
const activityFeed = [
  ...
  'Изменение ownership структуры поставщика',
  'Найден adverse media signal',
  'Выявлен procurement red flag',
]
    ...
    <section className="relative z-10 mx-auto max-w-7xl px-4 py-24 sm:px-5">
      <div className="max-w-5xl">
        ...
        <p className="mt-8 max-w-3xl text-lg leading-8 text-white/64 md:text-xl md:leading-9">
          Премиальная intelligence-инфраструктура для проверки контрагентов,
          ownership analysis, sanctions monitoring и executive screening.
        </p>
      </div>
