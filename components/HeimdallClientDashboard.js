...
const cases = [
  {
    company: 'Проверка поставщика',
    status: 'В процессе',
    risk: 'Средний',
    progress: 72,
  },
  {
    company: 'Проверка контрагента',
    status: 'Завершено',
    risk: 'Низкий',
    progress: 100,
  },
      ...
      <div className="mb-14 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h2 className="mt-8 text-5xl font-semibold tracking-[-0.06em] md:text-7xl">
            Закрытая рабочая зона клиента
          </h2>

          <p className="mt-6 max-w-3xl text-lg leading-8 text-white/64">
            Премиальный интерфейс для контроля проверок, статусов, отчетов и аналитических выводов HEIMDALL.
          </p>
        </div>
        ...
        <div className="grid gap-6">
          <div className="rounded-[42px] border border-white/10 bg-white/[0.045] p-8 backdrop-blur-2xl">
            ...
            <p className="mt-6 text-sm leading-7 text-white/60">
              Обнаружены потенциальные закупочные и ownership-риски у части контрагентов.
            </p>
          </div>
          ...
          <div className="rounded-[42px] border border-white/10 bg-white/[0.045] p-8 backdrop-blur-2xl">
            ...
            <div className="mt-8 grid gap-4">
              <div className="rounded-2xl border border-white/10 bg-black/20 px-5 py-4">
                Проверка руководителя.pdf
              </div>

              <div className="rounded-2xl border border-white/10 bg-black/20 px-5 py-4">
                Due Diligence поставщика.pdf
              </div>
            </div>
          </div>
        </div>
