...
const ruMenu = [
  ...
  ['Сопровождение', '/business-support', [['Комплексное сопровождение', '/business-support'], ['Клиентское приложение', '/client-app'], ['Личный кабинет', '/account'], ['Прайс-лист сопровождения', '/business-support#pricing']]],
...
const enMenu = [
  ...
  ['Support', '/business-support-en', [['Business Support', '/business-support-en'], ['Client Application', '/client-app-en'], ['Client Account', '/account'], ['Support Pricing', '/business-support-en#pricing']]],
          ...
          <nav className="hidden items-center gap-1 lg:flex">
            {menu.map(([title, href, items]) => (
              ...
              >
                ...
                <div className={`absolute left-1/2 top-[calc(100%+12px)] z-[9999] w-80 -translate-x-1/2 rounded-[26px] border border-white/15 bg-[#050816] p-3 shadow-[0_35px_100px_rgba(0,0,0,0.88)] ring-1 ring-sky-300/10 transition duration-200 ${activeDropdown === title ? 'pointer-events-auto translate-y-0 opacity-100' : 'pointer-events-none translate-y-3 opacity-0'}`}>
