        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-5">
          ...
          <nav className="hidden items-center gap-1 lg:flex">
            {menu.map(([title, href, items]) => (
              ...
              >
                <Link href={href} className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-sm text-white/70 transition hover:bg-white/7 hover:text-[#F7D784]">
                  {title}
