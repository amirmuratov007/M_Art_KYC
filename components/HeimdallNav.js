          ...
          <div className="mx-auto max-w-7xl rounded-[28px] border border-white/10 bg-white/[0.045] p-4">
            <div className="grid gap-4">
                  ...
                  <div className="grid gap-2">
                    {group.items.map(([label, href]) => (
                      <Link
                        ...
                        className="rounded-2xl px-4 py-3 text-base text-white/75 transition hover:bg-white/7 hover:text-[#F7D784]"
                      >
                        {label}
                      </Link>
                    ))}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Link href="/#lead" onClick={() => setOpen(false)} className="rounded-2xl bg-sky-500 px-4 py-3 text-center text-sm font-semibold text-white">Связаться</Link>
              </div>
            </div>
          </div>
        </div>
